...
GrassyCreekWatershed <- readOGR(dsn = "data/raw/watershed boundaries _ No Name and Grassy Creeks/", 
                                "Watersheds_grassy creek")
NoNameCreekWatershed <- readOGR(dsn = "data/raw/watershed boundaries _ No Name and Grassy Creeks/",
...
HUC1302 <- readOGR(dsn = "data/raw/NHDPLUS_H_1302_HU4_GDB.gdb/", 
                   "NHDFlowline")
#plot(HUC1302) # this is large so takes a while to plot
